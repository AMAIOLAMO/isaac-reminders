...
local lang_enum = {
    ...
    LLANG_CONFIG_MAP_SECTION = 47,
    LLANG_CONFIG_MAP_SPECIAL_ROOM_COLORMARKS_LABEL = 48,
    LLANG_CONFIG_MAP_SPECIAL_ROOM_COLORMARKS_DESC = 49,
    LLANG_CONFIG_MAP_SPECIAL_ROOM_UNVISITED_LABEL = 50,
    LLANG_CONFIG_MAP_SPECIAL_ROOM_VISITED_LABEL = 51,
}
